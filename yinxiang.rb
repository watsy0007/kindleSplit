...
authToken = "S=s1:U=8f7d9:E=14fe066853b:C=14888b557f8:P=1cd:A=en-devtoken:V=2:H=c2c5102ba7ea19f3f764c0adbe04ed25"
...
module ReadingMarkSDK
  class BookMark

  end
  class YinXiangSDK
    @defaultBook
    def findNoteBook(noteName)

    end

    def setNoteBook(defaultBook)

    end

    def findNote(noteName)

    end

    def setNote(noteName, bookMark)
